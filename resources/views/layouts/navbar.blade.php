            ...
            <div class="collapse navbar-collapse" id="navbars-host">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown {{ Request::is('pages') ? 'active' : '' }}">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdown-a" data-toggle="dropdown">INFORMATION DESK
                        </a>
                        <div class="dropdown-menu" aria-labelledby="dropdown-a">
                            <a class="dropdown-item" href="{{ url('/messages') }}">Message from Directors </a>
                            @if (Auth::check())
