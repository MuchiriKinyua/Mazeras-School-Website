...
@section('middle')
                        ...
                        @foreach ($histories as $history)
                            <div class="timeline__item">
                                <div class="timeline__content"
                                    ...
                                    <h2 style="background: white; color: black; padding: 10px; display: inline-block;">>{{ $history->date }}</h2>
                                    <p style="background: white; color: black; padding: 10px; display: inline-block;">{{ $history->description }}</p>
                                </div>
                            </div>
                        @endforeach
                    </div>
    ...
    <div class="gallery-co4ntainer p-5 bg-light">
        <div class="container">
